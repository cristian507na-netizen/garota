...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section id="promociones" className="container-page py-20 md:py-28">
        <div className="relative overflow-hidden rounded-[2rem] border border-border bg-gradient-to-br from-secondary/70 via-background to-accent/40 px-6 py-14 md:px-16 md:py-20">
          {/* Decorative blobs */}
          <div className="pointer-events-none absolute -top-24 -right-16 size-72 rounded-full bg-primary/8 blur-3xl" />
          <div className="pointer-events-none absolute -bottom-20 -left-10 size-60 rounded-full bg-primary/6 blur-2xl" />
          ...
          <div className="relative z-10 text-center max-w-2xl mx-auto">
            ...
            <p className="mt-6 text-muted-foreground leading-relaxed">
              Estamos preparando descuentos y paquetes especiales para
              consentirte. Déjanos tu WhatsApp y serás la primera en enterarte.
            </p>
            ...
            <div className="mt-10 grid grid-cols-3 gap-3 sm:gap-4">
              {[0, 1, 2].map((i) => (
                ...
                >
                  <Sparkles className="h-6 w-6 text-primary/40" strokeWidth={1.5} />
                </div>
              ))}
            </div>
